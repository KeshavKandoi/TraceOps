...
/* Distinct from IconWrench: used in the sidebar/nav for the tool *registry*,
   rendered as a bracketed schema grid rather than a single wrench. */
...
export function IconPlay(props: IconProps) {
  return base(<path d="M7 5l12 7-12 7V5z" />, props);
}
